...
def generate_payroll(id):
    ...
    try:
        ...
        result = {
            ...
            "Attendance Percentage": round(
                attendance_percentage,
                2
            ),

            "Total Deduction": round(
                total_deduction,
                2
            ),
...
def yearly_bonus_report(id):
    ...
    try:
        ...
        result = {
            ...
            "Total Yearly Bonus": round(
                total_bonus,
                2
            ),

            "Total Yearly Salary": round(
                total_salary,
                2
            ),
